 ...
 * Gold dividers, drop-cap serif, warm tones
 */
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="stagger-children">
            <h2
              className="fade-up text-[clamp(2rem,4vw,3.2rem)] leading-[1.15] font-semibold text-[oklch(0.25_0.03_55)] mb-8"
            ...
            <p
              className="fade-up text-[1.05rem] leading-[1.85] text-[oklch(0.40_0.03_55)] mb-6 font-light"
              style={{ fontFamily: "var(--font-body)" }}
            >
              <span
                className="text-[2.8rem] leading-[1] float-left mr-3 mt-1 font-semibold text-[oklch(0.38_0.04_145)]"
                style={{ fontFamily: "var(--font-display)" }}
              >
                F
              </span>
            ...
            <p
              className="fade-up text-[1.05rem] leading-[1.85] text-[oklch(0.40_0.03_55)] mb-8 font-light"
              style={{ fontFamily: "var(--font-body)" }}
            >
            ...
            <div className="fade-up flex items-center gap-12">
              <div>
                <span
                  className="block text-[2.5rem] font-semibold text-[oklch(0.38_0.04_145)]"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  50+
                </span>
                <span
                  className="text-[0.7rem] tracking-[0.15em] uppercase text-[oklch(0.50_0.03_55)]"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Natural Ingredients
                </span>
              </div>
              <div className="w-[1px] h-12 bg-[oklch(0.72_0.10_80/0.4)]" />
              <div>
                <span
                  className="block text-[2.5rem] font-semibold text-[oklch(0.38_0.04_145)]"
                  style={{ fontFamily: "var(--font-display)" }}
